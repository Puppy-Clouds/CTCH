...
- (void)addSubImageView
{
    ...
    [_imageView autoPinEdgesToSuperviewEdgesWithInsets:UIEdgeInsetsMake(5, 10, 5, 0) excludingEdge:ALEdgeRight];
...
- (void)addSubTitleLabel
{
    ...
    [_titleLabel autoPinEdge:ALEdgeLeft toEdge:ALEdgeRight ofView:_imageView withOffset:10];
...
- (void)addSubCategoryImageView
{
    ...
    [_categoryImageView autoPinEdgeToSuperviewEdge:ALEdgeLeft withInset:15];
    [_categoryImageView autoPinEdgeToSuperviewEdge:ALEdgeBottom withInset:7];
    [_categoryImageView autoSetDimensionsToSize:CGSizeMake(15, 15)];
