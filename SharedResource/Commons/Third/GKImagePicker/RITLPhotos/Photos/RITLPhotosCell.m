...
- (void)addSubMessageView
{
    ...
    [_messageView autoPinEdgesToSuperviewEdgesWithInsets:UIEdgeInsetsZero excludingEdge:ALEdgeTop];
    [_messageView autoSetDimension:ALDimensionHeight toSize:20];
...
- (void)addSubMessageImageView
{
    ...
    [_messageImageView autoPinEdgeToSuperviewEdge:ALEdgeLeft withInset:5];
    [_messageImageView autoPinEdgeToSuperviewEdge:ALEdgeBottom withInset:0];
    [_messageImageView autoSetDimensionsToSize:CGSizeMake(30, 20)];
...
- (void)addSubMessageLabel
{
    ...
    [_messageLabel autoPinEdge:ALEdgeLeft toEdge:ALEdgeRight ofView:self.messageImageView];
    [_messageLabel autoPinEdgeToSuperviewEdge:ALEdgeRight withInset:3];
    [_messageLabel autoPinEdgeToSuperviewEdge:ALEdgeBottom withInset:0];
    [_messageLabel autoSetDimension:ALDimensionHeight toSize:20];
...
- (void)addChooseControl
{
    ...
    [_chooseControl autoSetDimensionsToSize:CGSizeMake(45, 45)];
    [_chooseControl autoPinEdgeToSuperviewEdge:ALEdgeRight withInset:3];
    [_chooseControl autoPinEdgeToSuperviewEdge:ALEdgeBottom withInset:3];
...
- (void)addChooseImageView
{
    ...
    [_chooseImageView autoSetDimensionsToSize:CGSizeMake(25, 25)];
    [_chooseImageView autoPinEdgeToSuperviewEdge:ALEdgeRight withInset:0];
    [_chooseImageView autoPinEdgeToSuperviewEdge:ALEdgeBottom withInset:0];
