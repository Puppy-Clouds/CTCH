 ...
 - (void)autoLayoutSubViews
{
    ...
    [self.bottomBar autoSetDimension:ALDimensionHeight toSize:RITLPhotoIsiPhoneX?(83 - 5):44];
...
//    }];
    ...
    [self.collectionView autoPinEdge:ALEdgeBottom toEdge:ALEdgeTop ofView:self.bottomBar withOffset:0];
