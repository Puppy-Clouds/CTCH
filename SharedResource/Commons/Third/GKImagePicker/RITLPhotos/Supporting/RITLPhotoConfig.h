...
// 图片路径
#define ImageSrcName(file) [@"RITLPhotos.bundle" stringByAppendingPathComponent:file]
...
#define RITLPhotoSelectedName ImageSrcName(@"RITLSelected")
#define RITLPhotoDeselectedName ImageSrcName(@"RITLDeselected")

#define RITLPhotoBrowseBackImage ([UIImage imageNamed:ImageSrcName(@"RITLPhotoBack")])
