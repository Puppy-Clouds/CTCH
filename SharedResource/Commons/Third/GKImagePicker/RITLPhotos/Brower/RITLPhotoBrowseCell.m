...
- (void)createBottomScrollView
{
    if (self.bottomScrollView == nil)
    {
        ...
        [self.bottomScrollView autoPinEdgesToSuperviewEdgesWithInsets:UIEdgeInsetsMake(0, 5, 0, 5)];
...
- (void)createImageView
{
    if (self.imageView == nil)
    {
        ...
        [self.imageView autoMatchDimension:ALDimensionWidth toDimension:ALDimensionWidth ofView:self.bottomScrollView];
        [self.imageView autoMatchDimension:ALDimensionHeight toDimension:ALDimensionHeight ofView:self.bottomScrollView];
