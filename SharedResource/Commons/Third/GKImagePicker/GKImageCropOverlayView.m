...
//        [NSLocalizedString(@"GKImoveAndScale", @"") drawInRect:CGRectMake(10, (height - heightSpan) + (heightSpan / 2 - 20 / 2) , width - 20, 20) withFont:[UIFont boldSystemFontOfSize:20] lineBreakMode:NSLineBreakByTruncatingTail alignment:NSTextAlignmentCenter];
...
//        textAttrs[NSForegroundColorAttributeName] = CYNaviTitleColor;
        ...
        textAttrs[NSParagraphStyleAttributeName] = paragraphStyle;
        [NSLocalizedString(@"GKImoveAndScale", @"") drawInRect:CGRectMake(10, (height - heightSpan) + (heightSpan / 2 - 20 / 2), width - 20, 20) withAttributes:textAttrs];
