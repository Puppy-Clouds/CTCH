#
# Be sure to run `pod lib lint GKImagePicker.podspec' to ensure this is a
...
s.homepage         = 'http://192.168.1.117:8099/r/GKImagePicker.git'
# s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
s.license          = { :type => 'MIT', :file => 'LICENSE' }
s.author           = { 'LE' => '551998132@qq.com' }
s.source           = { :git => 'http://192.168.1.117:8099/r/GKImagePicker.git', :tag => s.version.to_s }
...
s.resource_bundles = {
    'GKImagePicker' => ['GKImages.bundle', 'TZImagePickerController/TZImagePickerController.bundle']
}
