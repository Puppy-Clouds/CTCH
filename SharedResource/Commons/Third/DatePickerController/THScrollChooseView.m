...
- (instancetype)initWithQuestionArray:(NSArray *)questionArray withDefaultDesc:(NSString *)defaultDesc {
    ...
    if (self = [super init]) {
        ...
        UIView *whiteView = [[UIView alloc]initWithFrame:CGRectMake(0, CGRectGetHeight(self.frame) - 300, CGRectGetWidth(self.frame), 300)];
        whiteView.backgroundColor = [UIColor whiteColor];
        [self addSubview:whiteView];

        //按钮所在区域
        UIView *viewBg = [[UIView alloc] initWithFrame:CGRectMake(0,0,THScreenW,THfloat(45))];
        [viewBg setBackgroundColor:RGBA(242, 246, 248, 1)];
        ...
        [cannel setTitleColor:MainNaviColor forState:UIControlStateNormal];
        cannel.tag = 1;
        ...
        [confirm setTitleColor:MainNaviColor forState:UIControlStateNormal];
        confirm.tag = 2;
