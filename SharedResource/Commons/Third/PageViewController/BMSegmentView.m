...
#define BMColor(r, g, b, a) [UIColor colorWithRed:(r)/255.0f green:(g)/255.0f blue:(b)/255.0f alpha:(a)]

#define BtnColor_Sel MainNaviColor///,默认颜色
#define BtnColor_UnSel [UIColor whiteColor]
#define BannerColor MainNaviColor //底部线条颜色,默认颜色
